...
int add_long(yuka_packet_t *, uint32_t);
uint32_t get_long(const uint8_t *);
int add_ip(yuka_packet_t *, in_addr_t);
int add_short(yuka_packet_t *, uint16_t);
uint16_t get_short(const uint8_t *);
uint16_t get_short_m(const uint8_t **);
int add_byte(yuka_packet_t *, uint8_t);
int add_string(yuka_packet_t *, const uint8_t *, int);
